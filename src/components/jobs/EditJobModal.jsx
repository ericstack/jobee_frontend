...
const EditJobModal = ({ isOpen, onClose, job, onSuccess }) => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      onSuccess?.(data.job ?? { ...job, ...formData });
      onClose();
    } catch (error) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800 shrink-0">
          <div>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Edit Job Posting</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Update the details for <span className="font-medium">{job.title}</span></p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5">
          <form id="edit-job-form" onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-4">
              ...
              <Field label="Job Title">
                <div className="relative">
                  ...
                  <input type="text" placeholder="e.g. Senior Software Engineer" {...register("title", { required: true })} className={`${inputClass} pl-9`} />
                </div>
              </Field>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Field label="Company Name">
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Your company name" {...register("company", { required: true })} className={`${inputClass} pl-9`} />
                  </div>
                </Field>
                ...
                <Field label="Contact Email">
                  <div className="relative">
                    ...
                    <input type="email" placeholder="hr@company.com" {...register("email", { required: true })} className={`${inputClass} pl-9`} />
                  </div>
                </Field>
              </div>
              ...
              <Field label="Location / Address">
                <div className="relative">
                  ...
                  <input type="text" placeholder="e.g. Makati City, Metro Manila" {...register("address", { required: true })} className={`${inputClass} pl-9`} />
                </div>
              </Field>
              ...
              <Field label="Job Description">
                <div className="relative">
                  ...
                  <textarea placeholder="Describe the role, responsibilities, and what you're looking for…" rows={4} {...register("description", { required: true })} className={`${inputClass} pl-9 resize-none`} />
                </div>
              </Field>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Field label="Industry">
                  <select {...register("industry", { required: true })} multiple className={`${inputClass} h-28`}>
                ...
                <Field label="Monthly Salary (PHP)">
                  <div className="relative">
                    ...
                    <input type="number" placeholder="e.g. 35000" {...register("salary", { required: true })} className={`${inputClass} pl-9`} />
                  </div>
                </Field>
                ...
                <Field label="No. of Vacancies" hint="Default is 1">
                  <div className="relative">
                    ...
                    <input type="number" placeholder="1" {...register("positions")} className={`${inputClass} pl-9`} />
                  </div>
                </Field>
              </div>
            </div>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100 dark:border-gray-800 shrink-0">
          <button type="button" onClick={onClose} className="px-4 py-2 rounded-lg text-sm text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
            Cancel
          </button>
          <button type="submit" form="edit-job-form" disabled={isSubmitting} className="bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white px-5 py-2 rounded-lg text-sm font-medium transition-colors">
